...
if(isset($_POST["btn_update"]))
{
  ...
  $q1="UPDATE `admin` SET `username`='$username',`fname`='$fname',`lname`='$lname',`email`='$email',`address`='$address',`gender`='$gender',`contact`='$contact',`dob`='$dob' ,`image`='$image' WHERE `id`='".$_GET['id']."'";
