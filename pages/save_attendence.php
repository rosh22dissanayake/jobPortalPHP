...
if (isset($_POST['btn_save'])) {
    ...
    $sql3 = "SELECT * FROM `tbl_subject` WHERE id = '".$subjectname."'";
    $result3=$conn->query($sql3);
    $row3=mysqli_fetch_array($result3);
    */

    	$sql = "INSERT INTO `tbl_attendence`(`stud_id`, `studentname`, `classname`,`subjectname`,`teachername`, `date`, `status`) VALUES ('$stud_id','$studentname','$classname','$subjectname','$teachername','$date','$status')";
