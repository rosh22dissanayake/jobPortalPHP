...
$q1="UPDATE `tbl_student` SET `sfname`='$sfname',`slname`='$slname',`classname`='$classname', `school`='$school',`semail`='$semail',`sgender`='$sgender',`sdob`='$sdob',`scontact`='$scontact',`fcontact`='$fcontact',`saddress`='$saddress' WHERE `id`='".$_GET['id']."'";
        ...
        <div class="row">
            <div class="col-lg-8" style="    margin-left: 10%;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  name="classname" id="lname" class="form-control" id="event" onkeydown="return alpha(event);" placeholder="Class Name" value="<?php echo $classname; ?>" required="">
                                </div>
                            </div>
                        </div>
              ...
              <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="scontact" class="form-control" placeholder="Student Contact Number" id="tbNumbers" minlength="10" maxlength="10" onkeypress="javascript:return isNumber(event)" required="" value="<?php echo $scontact; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="scontact" class="form-control" placeholder="Parents Contact Number" id="tbNumbers" minlength="10" maxlength="10" onkeypress="javascript:return isNumber(event)" required="" value="<?php echo $fcontact; ?>">
                    </div>
                </div>
            </div>
