  ...
  <div class="page-wrapper">
    ...
    <div class="row page-titles">
      <div class="col-md-5 align-self-center">
        <h3 class="text-primary">View Candidate</h3> </div>
      ...
      <div class="container-fluid">
       ...
       <div class="card">
        <div class="card-body">
          ...
          <a href="add_student.php"><button class="btn btn-primary">Add candidate</button></a>  
          <?php } } ?>
                ...
                while($row = $result->fetch_assoc()) { 
                  ...
                  */
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['sdegree']; ?></td>
                    <td><?php echo $row['fcontact']; ?></td>
                    <td><?php echo $row['saddress']; ?></td>

                    <td>
                      <?php if(isset($useroles)){  if(in_array("edit_student",$useroles)){ ?> 
                        <a href="edit_student.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="ti-reload"></i></button></a>
                      <?php } } ?>

                      <?php if(isset($useroles)){  if(in_array("delete_student",$useroles)){ ?> 
                        <a href="view_student.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-danger" ><i class="ti-trash"></i></button></a>
                      <?php } } ?>
