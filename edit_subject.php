...
if(isset($_POST["btn_update"]))
{
  ...
  $q1="UPDATE `tbl_subject` SET `subjectid`='$subjectid',`subjectname`='$subjectname' WHERE `id`='".$_GET['id']."'";
                            ...
                            <div class="input-states">
                                <form class="form-horizontal" method="POST" enctype="multipart/form-data" name="subjectform">
                                 ...
                                 <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" name="subjectid" class="form-control" placeholder="Subject Code" id="event" onkeydown="return isNumber(event);" value="<?php echo $subjectid; ?>" required="">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" name="subjectname" class="form-control" placeholder="Subject Name" id="event" onkeydown="return alpha(event);" value="<?php echo $subjectname; ?>" required="">
                                      </div>
                                  </div>
                              </div>
