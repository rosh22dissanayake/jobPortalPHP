...
extract($_POST);
    ...
    $q1="UPDATE `tbl_class` SET `class_code`='$class_code',`classname`='$classname' WHERE `id`='".$_GET['id']."'";
                            ...
                            <div class="input-states">
                              ...
                              <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" name="class_code" class="form-control" placeholder="Class Code" id="event" onkeydown="return isNumber(event);" value="<?php echo $class_code; ?>" required="">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" name="classname" class="form-control" placeholder="Class Name" id="event" onkeydown="return alpha(event);" value="<?php echo $classname; ?>" required="">
                                      </div>
                                  </div>
                              </div>
